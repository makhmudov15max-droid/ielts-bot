...
def get_admin_report_main_keyboard():
    """Admin Hisobot asosiy menyusi"""
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="👤 Bitta admin")],
            [KeyboardButton(text="🔥 Streak System")],
            [KeyboardButton(text="🏠 Bosh sahifa"), KeyboardButton(text="⬅️ Ortga")]
        ],
        resize_keyboard=True
    )
...
def get_employee_list_keyboard(employees: list, back_button_text: str = "⬅️ Ortga"):
    """Xodimlar ro'yxati uchun dinamik keyboard"""
    keyboard = []
    for emp in employees:
        keyboard.append([KeyboardButton(text=f"👤 {emp['name']}")])
    keyboard.append([KeyboardButton(text=back_button_text), KeyboardButton(text="🏠 Bosh sahifa")])
    return ReplyKeyboardMarkup(keyboard=keyboard, resize_keyboard=True)


# ================= SOZLAMALAR KEYBOARDS =================
def get_settings_main_keyboard():
    """Sozlamalar asosiy menyusi"""
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="👤 Hodim ish vaqtlari")],
            [KeyboardButton(text="📅 Ta'til sanalari")],
            [KeyboardButton(text="🏠 Bosh sahifa"), KeyboardButton(text="⬅️ Ortga")]
        ],
        resize_keyboard=True
    )
...
def get_work_time_hours_keyboard():
    """Ish vaqtini tanlash keyboardi"""
    return ReplyKeyboardMarkup(
        keyboard=[
...
def get_holiday_main_keyboard():
    """Ta'til sanalari asosiy menyusi"""
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="➕ Ta'til qo'shish")],
            [KeyboardButton(text="❌ Ta'tilni o'chirish")],
            [KeyboardButton(text="📋 Ta'til ro'yxati")],
            [KeyboardButton(text="🏠 Bosh sahifa"), KeyboardButton(text="⬅️ Ortga")]
        ],
        resize_keyboard=True
    )
...
def get_holiday_type_keyboard():
    """Bayram turini tanlash keyboardi"""
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="🎉 Mustaqillik kuni")],
            [KeyboardButton(text="🌙 Ramazon Hayit"), KeyboardButton(text="🐏 Qurbon Hayit")],
            [KeyboardButton(text="🎄 Yangi yil")],
            [KeyboardButton(text="😴 Dam olish kuni")],
