...
def calculate_cashier_salary(data: dict) -> dict:
    ...
    if debt_percentage == 0:
        ...
        multiplier = 2.5
        status_text = "Yaxshi (2.5x)"
    elif debt_percentage <= 4.0:
        multiplier = 2.0
        status_text = "O'rtacha (2.0x)"
    elif debt_percentage <= 6.0:
        multiplier = 1.8
        status_text = "Soniq (1.8x)"
    elif debt_percentage <= 8.0:
        multiplier = 1.5
        status_text = "Qoniqarsiz (1.5x)"
    elif debt_percentage <= 10.0:
        multiplier = 1.2
        status_text = "Yomon (1.2x)"
    else:
        multiplier = 1.0
