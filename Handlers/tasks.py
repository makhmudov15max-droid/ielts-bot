...
@tasks_router.callback_query(TaskStates.waiting_for_frequency, F.text == "Kuniga 1 marta")
...
@tasks_router.message(TaskStates.waiting_for_proof_type, F.text.in_(["Dumaloq video", "Rasm yuborish"]))
